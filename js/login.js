...
message_content = '';
var message_one ='<div class="message_contain"><div class="ring letmiddle">详细信息</div><div class="ringg" style="background-image: url(img/friend.png);"></div><p class="nickname">'
...
document.querySelector('#textbtn').onclick = function() {
	...
	$.ajax({
		...
		success: function(data) {
			...
			chatlist[chatmark].style.top = chatlist[chatmark].parentNode.offsetHeight-chatlist[chatmark].scrollHeight+'px';//底部重置
			// document.querySelector('#rotate').style.display = 'none';
